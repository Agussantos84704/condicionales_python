...
if numero_1 > 0 and numero_1 < 100:
    res_3 = 1
    print(f'{numero_1} es mayor a 0 y menor que 100 a la vez!')
else:
    res_3 = 2
    print(f'{numero_1} es no cumple con ambas condiciones')
...
if numero_1 < 10 or numero_2 > -2:
    res_4 = 1
    print(f'{numero_1} es menor que 10, o bien {numero_2} es mayor que -2')
else: 
    res_4 = 2
    print(f'{numero_1} es mayor que 10, o bien {numero_2} es menor que -2')
